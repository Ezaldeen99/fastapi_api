...
# WARNING: Ensure imports from `fastapi_api` comes after this line
from fastapi_api import app, settings, db  # noqa
from fastapi_api.cli import create_user, cli  # noqa
